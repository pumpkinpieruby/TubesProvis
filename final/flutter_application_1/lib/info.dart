...
Widget _buildArticleContainer({
  ...
  required BuildContext context, // Tambahkan BuildContext di parameter
}) {
  return GestureDetector(
    onTap: () {
      Navigator.push(
        context,
        MaterialPageRoute(builder: (context) => ArticlePage()), // Ganti ArticleDetailPage dengan halaman yang sesuai
      );
    },
    child: Container(
      width: double.infinity,
