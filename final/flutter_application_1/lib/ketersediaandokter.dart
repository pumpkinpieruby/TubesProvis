...
class _HealthInfoPageState extends State<HealthInfoPage> {
                            ...
                            Column(
                              ...
                              children: content.map((item) {
                                return _buildSubBoxes(
                                    item, MediaQuery.of(context).size.width);
                              }).toList(),
                            ),
                        ],
                      ),
  ...
  Widget _buildSubBoxes(String text, double width) {
    return GestureDetector(
      onTap: () {
        // Navigasi ke homepage ketika kotak dokter di-klik
        Navigator.push(
          context,
          MaterialPageRoute(builder: (context) => Pendaftaran2()), // Ganti dengan halaman Homepage yang benar
        );
      },
      child: Padding(
